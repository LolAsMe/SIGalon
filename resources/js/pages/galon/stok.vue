<template>
  <div class="row mb-5 mx-md-4">
    <div class="col transaksi">
      <div class="judul">
        <h4>Transaksi <span class="text-primary">Penyetokan</span></h4>
      </div>
      ...
      <div v-show="showPayer" class="mt-1">
        ...
        >
          <li
            ...
            @click="(payer_id = suplier.id), (showPayer = !showPayer)"
          >
            {{ suplier.nama }}
          </li>
        </ul>
        ...
        <div class="card-body p-0">
          <div v-if="showItem[0]" class="item border border-primary p-2">
            ...
            <div class="d-flex sepertiga mt-3">
              ...
              <div class="text-center">x {{ toCurrency(asets[0].harga_beli) }}</div>
          ...
          <div v-if="showItem[1]" class="item border border-primary p-2">
            ...
            <div class="d-flex sepertiga">
              ...
              <div class="text-center">x {{ toCurrency(asets[1].harga_beli) }}</div>
          ...
          <div v-if="showItem[2]" class="item border border-primary p-2">
            ...
            <div class="d-flex sepertiga">
              ...
              <div class="text-center">x {{ toCurrency(asets[2].harga_beli) }}</div>
...
export default {
  ...
  computed: {
    ...
    payer() {
      return this.supliers.find(
        (suplier) => suplier.id == this.payer_id
      );
    },
    utang() {
    ...
    totalAir() {
      return this.jumlahAir * this.asets[0].harga_beli;
    },
    totalGalon() {
      return this.jumlahGalon * this.asets[1].harga_beli;
    },
    totalKardus() {
      return this.jumlahKardus * this.asets[2].harga_beli;
    },
    jumlah() {
    ...
    transaksiItem() {
      ...
      if (this.jumlahAir > 0) {
        let data = [
          {
            kredit: this.jumlahAir * this.asets[0].harga_beli,
            jumlah: this.jumlahAir,
            harga: this.asets[0].harga_beli,
            keterangan: "test",
            tipe: "Saldo",
          },
          {
      ...
      if (this.jumlahGalon > 0) {
        let data = [
          {
            kredit: this.jumlahGalon * this.asets[1].harga_beli,
            jumlah: this.jumlahGalon,
            harga: this.asets[1].harga_beli,
            keterangan: "test",
            tipe: "Saldo",
          },
          {
      ...
      if (this.jumlahKardus > 0) {
        let data = [
          {
            kredit: this.jumlahKardus * this.asets[2].harga_beli,
            jumlah: this.jumlahKardus,
            harga: this.asets[2].harga_beli,
            keterangan: "test",
            tipe: "Saldo",
          },
          {
